  ...
  <div class="center">
    <nav id="main_nav">
      <ul>
        ...
        <li><a href="about.html" class="active">about</a><font>&nbsp;/&nbsp;</font></li>
      </ul>
    </nav>
  ...
  <div class="aboutbanner_box">
    ...
    <div class="aboutbanner_font">
      <h1><font>ABOUT US</font>
      	...
      	<!-- 
      	STUDI STARE HAS BEEN PRODUCING CREATIVE FILMS FOR CLIENTS IN SHANGHAI AND AROUD THE WORLD SINCE 2008.WE STRIVE TO VISUALIZE NARRATIVES AND INSPIRE CURIOSITY IN OUR AUDIENCES.WE LISTEN TO YOUR STORY,AND VE HELP TELL IT.
      	--> 
      </h1>
    </div>
  </div>
