		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu" data-auto-scroll="true"
					...
					<li class="last ">
						<a style="background:#000000;" href="/manage/admin-category-list.html"> 
					...
					<div class="col-md-12">
						<div class="portlet box blue" id="form_wizard_1">
							...
							<div class="portlet-body form">
								<form action="/manage/saveCategory" class="form-horizontal" method="post" id="submit_form">
...
<![endif]-->
	...
	<script src="/manage-resource/assets/scripts/form-wizard-category.js"></script>
	<!-- <script src="/manage-resource/assets/scripts/custom/table-editable.js"></script> -->
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
