		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu" data-auto-scroll="true"
					...
					<li class="last ">
						<a style="background:#000000;" href="/manage/admin-video-list.html" >
					...
					<div class="col-md-12">
						<div class="portlet box blue" id="form_wizard_1">
							...
							<div class="portlet-body form">
								<form action="/manage/saveVideo" class="form-horizontal" id="submit_form" method="post" enctype="multipart/form-data">
											...
											<div class="tab-content">
												...
												<div class="tab-pane active" id="tab1">
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<textarea class="form-control" rows="3" style="width:100%" name="description">${(video.description)!""}</textarea>
...
<![endif]-->
	...
	<script src="/manage-resource/assets/scripts/form-wizard-video.js"></script>
	<script src="/manage-resource/assets/scripts/table-editable-video.js"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
