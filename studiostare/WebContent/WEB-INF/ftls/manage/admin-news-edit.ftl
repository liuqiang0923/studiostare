...
<head>
<meta charset="utf-8" />
<title>Studio Stare | edit news</title>
		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu" data-auto-scroll="true"
					...
					<li class="last ">
						<a style="background:#000000;" href="/studiostare/manage/admin-news-list.html" >
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">Edit News Wizard</h3>
					...
					<div class="col-md-12">
						<div class="portlet box blue" id="form_wizard_1">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-reorder"></i> Edit News Wizard - <span
										...
										<div class="form-body">
											...
											<div class="tab-content">
												...
												<div class="tab-pane active" id="tab1">
													<h3 class="block">Provide news details</h3>
													...
													<div class="form-group">
														<label class="control-label col-md-3">Content <span
															class="required"> * </span>
														</label>
														<div class="col-md-4">
												...
												<div class="tab-pane" id="tab2">
													<h3 class="block">Provide news photo details</h3>
													<div class="form-group">
												...
												<div class="tab-pane" id="tab4">
													...
													<h4 class="form-section">News Info</h4>
													<div class="form-group">
													...
													<div class="form-group">
														<label class="control-label col-md-3">news content:</label>
														<div class="col-md-4">
															<p class="form-control-static" data-display="content">
															</p>
														</div>
													</div>
													<h4 class="form-section">News photo</h4>
													<div class="form-group">
...
<![endif]-->
	...
	<script src="/studiostare/manage-resource/assets/scripts/form-wizard-news.js"></script>
	<script src="/studiostare/manage-resource/assets/scripts/table-editable-news.js"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
