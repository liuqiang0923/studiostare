		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu" data-auto-scroll="true"
					...
					<li class="last ">
						<a style="background:#000000;" href="/manage/admin-admin.html" >
					...
					<div class="col-md-12">
						<div class="portlet box blue" id="form_wizard_1">
							...
							<div class="portlet-body form">
								<form action="/manage/saveAdmin" class="form-horizontal" id="submit_form" method="post" enctype="multipart/form-data">
