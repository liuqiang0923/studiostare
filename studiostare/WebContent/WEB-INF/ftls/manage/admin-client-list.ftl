...
<div class="page-container">
	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-auto-scroll="true"
					...
					<li class="last ">
						<a style="background:#000000;" href="/manage/admin-client-list.html"> 
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<form action="/manage/saveClientPic" class="form-horizontal" method="post" id="clientPicForm"  enctype="multipart/form-data">
						<div class="row">
							<div class="fileinput fileinput-new col-md-4" data-provides="fileinput">
								<div class="fileinput-preview thumbnail" style="width: 100%;" data-trigger="fileinput" id="clientimgdiv">
									<img src='${(clientPic.officeImgPath)!"/img/temp/clientsimg00.jpg"}'></img>
								</div>
...
<script src="/manage-resource/assets/scripts/table-managed-client.js" ></script>
<script>
