		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu" data-auto-scroll="true"
					...
					<li class="last ">
						<a style="background:#000000;" href="/manage/admin-leading-list.html" >
							<i class="fa fa-th"></i>
							<span class="title">
								Leading page
							</span>
					...
					<div class="col-md-12">
						<div class="portlet box blue" id="form_wizard_1">
							...
							<div class="portlet-body form">
								<form action="/manage/saveLeadingWord" class="form-horizontal" method="post" id="submit_form" enctype="multipart/form-data">>
...
<![endif]-->
	...
	<script src="/manage-resource/assets/scripts/form-wizard-leading.js"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
